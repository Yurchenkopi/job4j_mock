...
class IndexControllerTest {
    ...
    void initTest() {
        this.indexController = new IndexController(
                categoriesService, interviewsService, authService,
                notificationService, profilesService, topicsService
        );
    }
    ...
    void whenGetIndexPageExpectModelAttributeThenOk() throws JsonProcessingException {
        ...
        profileDTO.setId(1);
        profileDTO.setUsername("new_user");
        ...
        when(profilesService.getProfileById(anyInt())).thenReturn(Optional.of(profileDTO));
        when(interviewsService.getByTopicsIds(anyList(), anyInt(), anyInt())).thenReturn(Page.empty());
        ...
        var actualProfileInfo = model.getAttribute("users");
        ...
        assertThat(actualProfileInfo).usingRecursiveComparison().isEqualTo(Set.of(profileDTO));
    }
}